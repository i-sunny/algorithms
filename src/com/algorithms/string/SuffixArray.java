...
public class SuffixArray {
    ...
    public static int[] buildRank(String str) {
    ...
    public static int[] buildHeight(String str) {
        int[] sa = buildSuffixArray(str);
    ...
    public static int[] buildHeight2(String str) {
        int len = str.length();
        int[] sa = buildSuffixArray(str);
